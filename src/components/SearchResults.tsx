    ...
    <div className='flex flex-col ml-5'>
        ...
        <div className=' text-2xl font-bold mb-2 p-2 text-slate-200'>Songs</div>
        {
            ...
            songs.map((song: any, i: number) => {
                return(
                <div className={`grid grid-cols-2 text-gray-400  px-2 py-4 md:px-4 mb-3 hover:bg-slate-800 hover:text-blue-400 rounded-lg ${song.id === currentTrack && 'bg-slate-800'}`} key={song.id}>
